# Welcome to the Tiny Finch docs repository!

This repository contains documentation, coding examples, and guides on how to utilize [Tiny Finch](https://tinyfinch.chat). Whether you're looking to extend Tiny Finch's functionalities or learn how to integrate it with your applications, you'll find resources and examples here to guide you through the process.
...
-   contacting us on our Tiny Finch widget on our [website](https://tinyfinch.chat)
-   adding me (nils@tinyfinch.chat) on Slack Connect
-   emailing us on contact@tinyfinch.chat
...
-   [Override Tiny Finch css](guides/override-css/README.md)
